...
void main() {
  ...
  Widget buildTestableWidget({
    ...
    return MaterialApp(
      home: Scaffold(
        body: Center(
          child: DateField(controller: controller, onFinishFunction: onFinish),
        ),
      ),
    );
  }
  ...
  group('DateField - Entrada de Texto e Validação', () {
    ...
    testWidgets(
      '5. Digitar data válida atualiza o controller após o debounce',
      (tester) async {
        final controller = DateFieldController(
          firstDate: firstDate,
          lastDate: lastDate,
    ...
    testWidgets('6. Digitar data inválida (formato) gera erro após debounce', (
      ...
      expect(
        ...
        isNotNull,
      ); // Deve ter mensagem de 'invalidFormat'
    });
    ...
    testWidgets('7. Digitar data fora do intervalo (outOfRange) gera erro', (
      ...
      expect(
        controller.value,
        isNull,
      ); // Ou valor base dependendo da sua regra de negócio
  ...
  group('DateField - Ciclo de Vida', () {
    testWidgets(
      '15. didUpdateWidget reconecta o novo controller corretamente',
      (tester) async {
        final controller1 = DateFieldController(
          firstDate: firstDate,
          lastDate: lastDate,
        );
        final controller2 = DateFieldController(
          firstDate: firstDate,
          lastDate: lastDate,
        );
